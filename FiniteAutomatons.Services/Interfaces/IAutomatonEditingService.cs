...
public interface IAutomatonEditingService
{
    ...
    (bool Ok, char ProcessedSymbol, string? Error) AddTransition(AutomatonViewModel model, int fromId, int toId, string symbol, string? stackPop = null, string? stackPush = null);
