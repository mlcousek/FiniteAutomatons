...
public class AutomatonPresetController : Controller
{
    private readonly IAutomatonGeneratorService generatorService;
    private readonly IAutomatonMinimizationService minimizationService;
    private readonly IAutomatonTempDataService tempDataService;

    public AutomatonPresetController(IAutomatonGeneratorService generatorService, IAutomatonMinimizationService minimizationService, IAutomatonTempDataService tempDataService)
    {
